...
contract InvestinStrategyToken is ERC20("PCS(BUSD-WBNB)LP-CAKE", "IVNs-1"), Ownable, ReentrancyGuard, iStrategy {//3213k 3172k 
  ...
  constructor(address[] memory _fundFactories) public {
    ...
    function reinvest() public nonReentrant{
        ...
        uint swapAmount = calcOptimalSwapAmt(resT0, amount);
        uint token0Amount = amount.sub(swapAmount);
