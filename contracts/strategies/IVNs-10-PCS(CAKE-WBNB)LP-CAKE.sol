...
contract InvestinStrategyToken is ERC20("PCS(CAKE-WBNB)LP-CAKE", "IVNs-10"), Ownable, ReentrancyGuard, iStrategy {//3213k 3172k 
    ...
    iExchangePair constant lPToken = iExchangePair(0x0eD7e52944161450477ee417DE9Cd3a859b14fD0);
  ...
  constructor(address[] memory _fundFactories) public {
    ...
    function reinvest() public nonReentrant{
        ...
        //Here token0 is CAKE itself, lets swap an aoptimum amount of CAKE to token1 i.e. WBNB to provide liquidity 
    ...
    function getStrategyTokenPrice() public view override returns (uint) {
        ...
        path_TokentoStableCoin[1] = stableCoin;
