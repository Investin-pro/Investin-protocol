...
contract InvestinStrategyToken is ERC20("WS(WEX-WBNB)LP-WEX", "IVNs-12"), Ownable, ReentrancyGuard, iStrategy {//3213k 3172k 
    ...
    iExchangePair constant lPToken = iExchangePair(0xb4814f1ca673dBE9a2637C5dd4e94A4a0ED834C6);
  ...
  constructor(address[] memory _fundFactories) public {
    ...
    function reinvest() public nonReentrant{
        ...
        //Swaping an optimal amount of WEX to WBNB to add liquidity 
        ...
        uint token1Amount = exchangeRouter.swapExactTokensForTokens(swapAmount, 0, path_RewardToToken, address(this), block.timestamp)[1];
