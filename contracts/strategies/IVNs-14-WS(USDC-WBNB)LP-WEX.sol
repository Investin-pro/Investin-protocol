...
contract InvestinStrategyToken is ERC20("WS(USDC-WBNB)LP-WEX", "IVNs-14"), Ownable, ReentrancyGuard, iStrategy {//3213k 3172k 
  ...
  constructor(address[] memory _fundFactories) public {
    ...
    function reinvest() public nonReentrant{
        ...
        //Swaping all WEX reward to WBNB and then an optimal amount of WBNB to IVN to add liquidity 
