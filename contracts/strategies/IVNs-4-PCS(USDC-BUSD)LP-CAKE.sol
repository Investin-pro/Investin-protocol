...
contract InvestinStrategyToken is ERC20("PCS(USDC-BUSD)LP-CAKE", "IVNs-4"), Ownable, ReentrancyGuard, iStrategy {//3213k 3172k 
    ...
    iExchangePair constant lPToken = iExchangePair(0x2354ef4DF11afacb85a5C7f98B624072ECcddbB1);
    address constant token0 = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
  ...
  constructor(address[] memory _fundFactories) public {
    ...
    function reinvest() public nonReentrant{
        ...
        uint amount = exchangeRouter.swapExactTokensForTokens(reward, 0, path_RewardToToken1, address(this), block.timestamp)[1];
        (uint resT1, , ) = lPToken.getReserves();
        uint swapAmount = calcOptimalSwapAmt(resT1, amount);
        uint token1Amount = amount.sub(swapAmount);
